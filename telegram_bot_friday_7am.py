...
MESSAGE_TEMPLATE_1 = f"""Chanthy: FT Drop your Weekly Plan and Daily Teaching Notes. 1A-Pre2AII

Deadline: 9:30 AM."""

MESSAGE_TEMPLATE_2 = f"""Pha & Derith: FT Drop your Weekly Plan and Daily Teaching Notes. 2A-5B
...
def log(msg):
    print(msg)
    with open("/Users/macmini/Documents/DPSS Telegram/bot_friday_7am.log", "a") as f:
...
if __name__ == "__main__":
    ...
    for idx, msg in enumerate(messages):
        ...
        log(f"Sending Friday 7 AM message {idx+1} (Numbered {num})...")
